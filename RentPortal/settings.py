"""
Django settings for RentPortal project.
...
ALLOWED_HOSTS = ['stingymeanyrentportal.herokuapp.com','127.0.0.1']
...
WSGI_APPLICATION = 'RentPortal.wsgi.application'
